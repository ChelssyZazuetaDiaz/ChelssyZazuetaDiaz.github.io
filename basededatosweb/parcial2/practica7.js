...
function pintar(p1,p2,p3){
    document.getElementById("cuadro"= +p1).style.backgroundColor = "#aac319";
    document.getElementById("cuadro"= +p2).style.backgroundColor = "#aac319";
    document.getElementById("cuadro"= +p3).style.backgroundColor = "#aac319";
}